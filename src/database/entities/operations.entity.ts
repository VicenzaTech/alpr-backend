...
import { Customer, Material, MaterialUnit, Vehicle } from './master-data.entity';
...
export class OrderItem {
    ...
    @Column({ name: 'quantity_planned', type: 'decimal', precision: 18, scale: 3, nullable: true })
    quantityPlanned?: string;

    @Column({ name: 'quantity_actual', type: 'decimal', precision: 18, scale: 3, nullable: true })
...
export class WeighTicket {
    ...
    @Column({ name: 'gross_weight_t', type: 'decimal', precision: 18, scale: 3, nullable: true })
    grossWeightT?: string;

    @Column({ name: 'tare_weight_t', type: 'decimal', precision: 18, scale: 3, nullable: true })
    tareWeightT?: string;

    @Column({ name: 'net_weight_t', type: 'decimal', precision: 18, scale: 3, nullable: true })
    netWeightT?: string;

    @Column({ length: 20, nullable: true })
    unit?: string;

    @Column({ name: 'price_per_unit', type: 'decimal', precision: 18, scale: 2, nullable: true })
    pricePerUnit?: string;
